...
import {BurgerStack} from '../types/types';

const Tab = createBottomTabNavigator<BurgerStack>();
  ...
  return (
    <>
      <Tab.Navigator
        ...
        <Tab.Screen name={'Lesson1'} component={Lesson_1} />
        <Tab.Screen name={'Lesson2'} component={Lesson_2} />
        <Tab.Screen name={'Lesson3'} component={Lesson_3} />
        <Tab.Screen name={'Lesson4'} component={Lesson_4} />
